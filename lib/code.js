    ...
    class Main {
        ...
        start(callback = null) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (Main.isCreated == false) {
                    var res_api = yield Main.netMgr.selectApi();
                    if (!res_api) {
                        ...
                        if (Main.loginFunctionCallback)
                            Main.loginFunctionCallback(res);
                ...
                if (Main.isWalletOpen()) {
                    ...
                    BlackCat.ViewTransConfirm.callback = (params) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                            try {
                                var res = yield Main.wallet.makeRawTransaction(params);
                            }
                            catch (e) {
                                var res = new BlackCat.Result();
                                res.err = true;
        ...
        static doPlatNotiyRefund(params) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                tran.version = 0;
                var r = yield BlackCat.tools.WWW.api_getcontractstate(BlackCat.tools.CoinTool.id_SGAS);
                if (r && r["script"]) {
        ...
        static changeNetType(type) {
            return __awaiter(this, void 0, void 0, function* () {
                var res = yield Main.netMgr.change(type);
                if (res) {
                    var callback_data = {
        ...
        static checkAccountTypeLogin(account) {
            var type = "";
        ...
        static checkAccountTypeRegister(account) {
            var type = "";
            var regex = /^([0-9A-Za-z\-_\.]+)@([0-9A-Za-z]+\.[a-zA-Z]{2,3}(\.[a-zA-Z]{2})?)$/g;
            if (regex.test(account)) {
                type = "email";
            ...
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    this.hosts.forEach(host => {
                        fetch(host + this.check_params).then(response => {
                ...
                return yield this.checkFirst(0);
            });
        }
        checkFirst(count) {
            return __awaiter(this, void 0, void 0, function* () {
...
(function (BlackCat) {
    class NetMgr {
        ...
        selectApi() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.ApiTool.base_url = "http://182.254.139.130/apic_v2/apic_user.php";
                return true;
            });
        }
        selectNode() {
            BlackCat.tools.WWW.api = this.nodes[this.type][1];
            return true;
        }
        change(type = 2) {
            return __awaiter(this, void 0, void 0, function* () {
                if (this.type != type) {
                    ...
                    switch (type) {
                        case 1:
                            return yield this.change2Main();
                        case 2:
                            return yield this.change2test();
                        default:
                            return false;
                    }
                }
...
(function (BlackCat) {
    class ForgetPasswordView extends BlackCat.ViewBase {
        create() {
            ...
            this.inputUid.placeholder = BlackCat.Main.langMgr.get("forgetpass_inputUid");
            ...
            this.inputAccount.placeholder = BlackCat.Main.langMgr.get("forgetpass_inputAccount");
        ...
        validateAccount(emptySkip = true) {
            return __awaiter(this, void 0, void 0, function* () {
                if (this.empty(this.inputAccount.value)) {
                    if (emptySkip)
                        return;
                    BlackCat.Main.showErrMsg(("forgetpass_inputAccount_err"));
                    return false;
                }
                return true;
            });
        ...
        validateUid(emptySkip = true) {
            return __awaiter(this, void 0, void 0, function* () {
                if (this.empty(this.inputUid.value)) {
                    if (emptySkip)
                        return false;
                    BlackCat.Main.showErrMsg(("forgetpass_inputUid_err"));
                    return false;
                }
                if (this.checkUidFormat() == false) {
                    BlackCat.Main.showErrMsg(("forgetpass_inputUid_format_err"));
                    return false;
                }
                return true;
            });
        ...
        doForgetPassword() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!(yield this.validateVpass()))
                    return;
                var accountType = BlackCat.Main.checkAccountTypeRegister(this.inputAccount.value);
                var res;
                switch (accountType) {
                    case 'email':
                        res = yield BlackCat.ApiTool.forgetPassByEmail(this.inputUid.value, this.inputAccount.value, this.inputCode.value, this.inputVpass.value);
                        break;
                    case 'phone':
                        res = yield BlackCat.ApiTool.forgetPassByPhone(this.inputUid.value, this.inputAccount.value, this.inputCode.value, this.inputVpass.value);
                        break;
                    default:
                        return;
                }
        ...
        count_down() {
            ...
            var time = setInterval(() => {
                if (i > 0 && this.getCodeCount != null) {
                    i--;
                    this.getCodeCount.innerText = BlackCat.Main.langMgr.get("forgetpass_getCodecountRetry") + "(" + i + ")";
                }
        ...
        doGetCode() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (accountType) {
                    case 'email':
                        res = yield BlackCat.ApiTool.getForgetCodeByEmail(this.inputUid.value, this.inputAccount.value);
                        break;
                    case 'phone':
                        res = yield BlackCat.ApiTool.getForgetCodeByPhone(this.inputUid.value, this.inputAccount.value);
                        break;
                    default:
                        return;
                }
...
(function (BlackCat) {
    class LoginView extends BlackCat.ViewBase {
        create() {
            ...
            this.inputAccount.placeholder = BlackCat.Main.langMgr.get("login_inputAccount");
            this.ObjAppend(telInput, this.inputAccount);
            var passInput = this.objCreate("div");
            passInput.classList.add("pc_login_inputbox");
            this.ObjAppend(divInput, passInput);
        ...
        doLogin() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!this.verifyAccount()) {
                    BlackCat.Main.showErrMsg("login_inputAccount_err", () => {
                        this.inputAccount.focus();
                    });
                    return;
                }
                ...
                var accountType = BlackCat.Main.checkAccountTypeLogin(this.inputAccount.value);
                var res;
                switch (accountType) {
                    case 'email':
...
(function (BlackCat) {
    class MainView extends BlackCat.ViewBase {
        ...
        changNetType() {
            var type = BlackCat.Main.netMgr.type;
            switch (type) {
                case 1:
...
(function (BlackCat) {
    class ModifySexView extends BlackCat.ViewBase {
        start() {
            ...
            var selectSex = BlackCat.Main.user.info.sex;
            if (selectSex == "1") {
...
(function (BlackCat) {
    class PayReceivablesView extends BlackCat.ViewBase {
        constructor() {
            super();
            this.gasBalance = BlackCat.Main.viewMgr.payView.gas;
            this.toaddress = "";
            this.isDomain = false;
            this.addrerr = "";
        }
        create() {
            ...
            var popupTitle = this.objCreate('div');
            popupTitle.classList.add("pc_popup_title");
            popupTitle.innerText = BlackCat.Main.langMgr.get("pay_received");
            this.ObjAppend(popupbox, popupTitle);
            ...
            this.textareaAddress.innerHTML = BlackCat.Main.user.info.wallet;
            ...
            butreceivables.textContent = BlackCat.Main.langMgr.get("copy");
            butreceivables.onclick = () => {
                var idcopy = this.textareaAddress;
                idcopy.select();
        ...
        toRefer() {
            if (BlackCat.PayTransferView.refer) {
                BlackCat.Main.viewMgr.change(BlackCat.PayTransferView.refer);
                BlackCat.PayTransferView.refer = null;
            }
        }
    }
...
(function (BlackCat) {
    class PayTransferView extends BlackCat.ViewBase {
        ...
        doTransfer() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!(yield this.verify_addr())) {
                    BlackCat.Main.showErrMsg("pay_transferToAddrError", () => {
                        this.inputTransferAddr.focus();
                    });
                    return;
                }
        ...
        verify_addr() {
            return __awaiter(this, void 0, void 0, function* () {
                let isDomain = BlackCat.tools.NNSTool.verifyDomain(this.inputTransferAddr.value);
                let isAddress = BlackCat.tools.NNSTool.verifyAddr(this.inputTransferAddr.value);
                if (isDomain) {
                    try {
                        this.inputTransferAddr.value = this.inputTransferAddr.value.toLowerCase();
                        let addr = yield BlackCat.tools.NNSTool.resolveData(this.inputTransferAddr.value);
                        if (addr) {
                            this.toaddress = addr;
                            this.isDomain = true;
                            this.addrerr = 'false';
                    ...
                    try {
                        if (BlackCat.tools.neotools.verifyPublicKey(this.inputTransferAddr.value)) {
...
(function (BlackCat) {
    class PayView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            this.payMyWallet.textContent = BlackCat.Main.user.info.name;
            this.ObjAppend(divMyWallet, this.payMyWallet);
            var payRefresh = this.objCreate("a");
            payRefresh.classList.add("iconfont");
            payRefresh.innerHTML = BlackCat.Main.langMgr.get("pay_refresh");
            payRefresh.onclick = () => {
                this.doGetBalances();
                this.doGetWalletLists();
            };
            ...
            spanWalletDetail.innerHTML = BlackCat.Main.langMgr.get("pay_wallet_detail");
        ...
        makeRefundTransaction() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var scriptaddress = BlackCat.tools.CoinTool.id_SGAS.hexToBytes().reverse();
                var login = BlackCat.tools.LoginInfo.getCurrentLogin();
                var utxos_assets = yield BlackCat.tools.CoinTool.getsgasAssets();
                ...
                if (r && r["script"]) {
                    ...
                    if (r) {
                        if (r.txid) {
                            ...
                            var logRes = yield BlackCat.ApiTool.addUserWalletLogs(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, r.txid, "0", refundCount, "2", '{"sbParamJson":"' + paramJson_tmp + '", "sbPushString": "refund", "nnc": "' + BlackCat.tools.CoinTool.id_SGAS + '"}', BlackCat.Main.netMgr.type);
                            if (logRes.r) {
...
(function (BlackCat) {
    class RegisterView extends BlackCat.ViewBase {
        create() {
            ...
            this.inputAccount = this.objCreate("input");
            this.inputAccount.type = "text";
            this.inputAccount.placeholder = BlackCat.Main.langMgr.get("register_inputAccount");
        ...
        validateAccount(emptySkip = true) {
            return __awaiter(this, void 0, void 0, function* () {
                if (this.empty(this.inputAccount.value)) {
                    if (emptySkip)
                        return;
                    BlackCat.Main.showErrMsg(("register_inputAccount_err"));
                    return false;
                }
        ...
        validateUid(emptySkip = true) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.checkUidFormat() == false) {
                    BlackCat.Main.showErrMsg(("register_inputUid_format_err"));
                    return false;
                }
        ...
        count_down() {
            ...
            var time = setInterval(() => {
                if (i > 0 && this.getCodeCount != null) {
                    i--;
                    this.getCodeCount.innerText = BlackCat.Main.langMgr.get("register_getCodecountRetry") + "(" + i + ")";
                }
                else if (this.getCodeCount != null) {
                    clearInterval(time);
                    this.getCodeCount.style.display = "none";
        ...
        doGetCode() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (accountType) {
                    case 'email':
                        res = yield BlackCat.ApiTool.getEmailCode(this.inputAccount.value);
                        break;
                    case 'phone':
...
(function (BlackCat) {
    class ViewAlert extends BlackCat.ViewBase {
        create() {
            ...
            alterText.textContent = BlackCat.Main.langMgr.get(ViewAlert.content, ViewAlert.content_ext);
...
(function (BlackCat) {
    class ViewConfirm extends BlackCat.ViewBase {
        create() {
            ...
            var alterText = this.objCreate("div");
            alterText.classList.add("pc_altertext");
            alterText.textContent = BlackCat.Main.langMgr.get(ViewConfirm.content);
            this.ObjAppend(alter, alterText);
            var popupbutbox = this.objCreate('div');
            popupbutbox.classList.add("pc_popupbutbox");
            this.ObjAppend(alter, popupbutbox);
        ...
        create() {
            ...
            divLoading.innerHTML =
                "<div class='pc_loading1'></div>"
                    ...
                    + "<p id='pc_loadingtext'>" + BlackCat.Main.langMgr.get(ViewLoading.content) + "</p>";
...
(function (BlackCat) {
    class ViewToast extends BlackCat.ViewBase {
        create() {
            ...
            var alterText = this.objCreate("div");
            alterText.classList.add("pc_altertext");
            alterText.textContent = BlackCat.Main.langMgr.get(ViewToast.content);
...
(function (BlackCat) {
    class ApiTool {
        ...
        static addUserWalletLogs(uid, token, txid, g_id, cnts, type, params, net_type) {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    BlackCat.StorageTool = StorageTool;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class User {
        ...
        logout() {
            ...
            this.info = new BlackCat.UserInfo();
            BlackCat.tools.StorageTool.delStorage("current-address");
            BlackCat.tools.StorageTool.delStorage("login-info-arr");
        }
        getWalletFileCache() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!this.info) {
...
(function (BlackCat) {
    ...
    class NEOGAMESDK {
        ...
        static getSgasBalance(callback) {
        ...
        static invokescript(data, callback) {
        ...
        static makeRawTransaction(data, callback) {
        ...
        static makeRecharge(data, callback) {
        ...
        static getRecharge(data, callback) {
    ...
    BlackCat.NEOGAMESDK = NEOGAMESDK;
    class Result {
    }
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (r) {
                        if (r["txid"]) {
                            ...
                            var logRes = yield BlackCat.ApiTool.addUserWalletLogs(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, r["txid"], BlackCat.Main.appid, "", "5", JSON.stringify(params), BlackCat.Main.netMgr.type);
